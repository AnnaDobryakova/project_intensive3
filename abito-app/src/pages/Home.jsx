                                ...
                                <div className="content-side__box">
                                    <div className="content-side__list">
                                        <div className="content-side__list-item">
                                            <img className="content-side__list-item--img" src="/images/side-info-1.svg" alt="side-info-1" />
                                        ...
                                        <div className="content-side__list-item">
                                            <img className="content-side__list-item--img" src="/images/side-info-2.svg" alt="side-info-2" />
                                        ...
                                        <div className="content-side__list-item">
                                            <img className="content-side__list-item--img" src="/images/side-info-3.svg" alt="side-info-3" />
